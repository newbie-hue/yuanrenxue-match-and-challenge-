...
if (_0x2e34bc === undefined) {
    if (_0xc77418['aGyVwa'] === undefined) {
        var _0x2c8af7 = function(_0x57aac4) {
            ...
            this['HUOqfE'] = [0x1, 0x0, 0x0],this['ZEfZEh'] = function() {return 'newState';},this['ZkEluo'] = '\x5cw+\x20*\x5c(\x5c)\x20*{\x5cw+\x20*',this['WzlKmV'] = '[\x27|\x22].+[\x27|\x22];?\x20*}';};
...
// function btoa(value) {
//
//     var s = new Buffer.from(value).toString("base64")
//     return s
//
// }
...
var get_value= function(){
    //_$pr = new Array("b61147b40b799efefcfd0af4afdd6309", "9b97ac20fc4987090299829f1cab9623", "95d03c6a1c4b661912086d07dd1140e8", "3eca403f7adef3e2e4d02c05fcff86d2")
    _$pr = new Array()
    for(var i = 0 ; i < 4;i++){
    ...
    return [_$yw,m,RM4hZBv0dDon443M,f]
